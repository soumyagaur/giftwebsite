...
export default function PersonalizedPage() {
  ...
  const slug = "personalized";
  const occasionName = "Personalized";

  const uniqueCards = occasionCards[slug] || [];

  const bannerImage = "/images/unnamed (1).jpg";
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-10">
        ...
        <p className="text-gray-600 mt-2 mb-8">
          Explore curated personalized gifts made just for your loved ones.
        </p>

        {uniqueCards.length === 0 ? (
          <p className="text-center text-gray-600 py-20">
            No personalized gifts available yet.
          </p>
        ) : (
